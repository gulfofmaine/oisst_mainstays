...
# Plot the extent in the projection we made
ggplot() +
...
Pretty good showcase of how something that is "rectangular" by its lat/lon dimensions that has its shape change to when projected onto a non-flat surface of the earth. To get the OISST anomalies curved the originals were cropped using the corner ccoordinates of the extent plotted above. The raster was then warped into a regular grid in the stereographic projection displayed below.
