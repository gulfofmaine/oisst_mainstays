...
```{r}
# Pick Area
area_comp <- area_hw$`Global Oceans` 
...
### Gulf of Maine in May

May of 2021, particularly mid-May was an exceptionally hot time for the Gulf of Maine. Here is how the average temperature and anomaly strength compares across other years in the record. For comparison 2012 has also been flagged as it is the hottest year on recent record.
...
ggplot(filter(month_comps, color_flag == "Remaining Years"), 
  ...
  geom_jitter(data = filter(month_comps, color_flag == "2012"), 
              width = 0, height = 0.1, size = 2) +
  geom_jitter(data = filter(month_comps, color_flag == "2021"), 
              width = 0, height = 0.1, size = 2) +
...
ggplot(filter(month_comps, color_flag == "Remaining Years"), 
  ...
  geom_jitter(width = 0, height = 0.1) +
  geom_jitter(data = filter(month_comps, color_flag == "2012"), width = 0, height = 0.1, size = 2) +
  geom_jitter(data = filter(month_comps, color_flag == "2021"), width = 0, height = 0.1, size = 2) +
  scale_color_manual(values = color_key) +
  labs(x = expression("Area Temperature Anomaly"~~degree~C),
       y = "Month",
       color = "Data Source")
...
ggplot(filter(month_comps, color_flag == "Remaining Years"), 
  ...
  geom_jitter(data = filter(month_comps, color_flag == "2021"), width = 0, height = 0.1, size = 2) +
  scale_color_manual(values = color_key) +
  labs(x = expression("Temperature Distance from Climate\n(Sum of Daily Anomalies)"),
       y = "Month",
       color = "Data Source")
```
