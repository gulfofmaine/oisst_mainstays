...
# Future Temperature Development Needs
...
**Continuous Integration** Currently to create an update a file is downloaded manually and the update notebooks are run in sequence manually. If the data download can be scheduled we should be able to schedule running the notebooks as well to provide a consistent update scchedule.
