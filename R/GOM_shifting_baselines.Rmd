...
## Impact on Heatwave Events {.tabset .tabset-pills}
...
hw_dumbbell <- function(wave_summary){
  ...
  hw_counts <- ggplot(wave_summary) +
    ...
    geom_point(aes(x = num_waves, y = yr, color = "1982-2011 Climatology"), size = 2) +
    geom_point(aes(x = w, y = yr, color = "1991-2020 Climatology"), size = 2) +
    geom_vline(xintercept = 0, color = "gray30", linetype = 3) +
    labs(x = "Heatwave Events", y = "", color = "") +
    scale_color_gmri() 
  ...
  hw_lengths <- ggplot(wave_summary) +
    geom_segment(aes(y = yr, 
                 ...
                 size = 0.5, 
                 arrow = arrow(length = unit(0.25, "cm"))) +
    geom_point(aes(x = avg_length, y = yr, color = "1982-2011 Climatology"), size = 2) +
    geom_point(aes(x = x, y = yr, color = "1991-2020 Climatology"), size = 2) +
    geom_vline(xintercept = 0, color = "gray30", linetype = 3) +
    labs(x = "Heatwave Events", y = "", color = "") +
    scale_color_gmri() 
  ...
  hw_temps <- ggplot(wave_summary) +
    geom_segment(aes(y = yr, 
                 ...
                 size = 0.5, 
                 arrow = arrow(length = unit(0.25, "cm"))) +
    geom_point(aes(x = avg_intensity, y = yr, color = "1982-2011 Climatology"), size = 2) +
    geom_point(aes(x = y, y = yr, color = "1991-2020 Climatology"), size = 2) +
    geom_vline(xintercept = 0, color = "gray30", linetype = 3) +
    labs(x = "Heatwave Events", y = "", color = "") +
    scale_color_gmri() 
  ...
  hw_peaks <-  ggplot(wave_summary) +
    geom_segment(aes(y = yr, 
                 ...
                 size = 0.5, 
                 arrow = arrow(length = unit(0.25, "cm"))) +
    geom_point(aes(x = peak_intensity, y = yr, color = "1982-2011 Climatology"), size = 2) +
    geom_point(aes(x = z, y = yr, color = "1991-2020 Climatology"), size = 2) +
    geom_vline(xintercept = 0, color = "gray30", linetype = 3) +
    labs(x = "Heatwave Events", y = "", color = "") +
    scale_color_gmri() 
